...
- **Library** — browse prompts by category, tag, or favorites; rename or delete categories and tags in place from the sidebar (deleting a tag removes it from all prompts without deleting the prompts).
